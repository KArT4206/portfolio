...
import { uploadAttachmentAction, type UploadAttachmentState } from "./actions";
...
export default function AttachmentUploadForm({ projectId }: { projectId: string }) {
  const boundAction = uploadAttachmentAction.bind(null, projectId);
  const initialState: UploadAttachmentState = { error: null };
